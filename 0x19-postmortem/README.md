Postmortem
Upon the release of ALX's System Engineering & DevOps project 0x19, approximately 04:00 East African Time (EAT) here in Kenya, an outage occurred on an isolated Ubuntu 14.04 container running an Apache web server. GET requests on the server led to 500 Internal Server Error's, when the expected response was an HTML file defining a simple Holberton WordPress site.

Debugging Process
I, Irene,  encountered the issue upon opening the project and promptly proceeded to undergo solving the problem.
 process: 
